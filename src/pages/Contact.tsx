                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">1-800-ECO-SHOP (1-800-326-7467)</p>
                      <p className="text-sm text-gray-500">Free call within US</p>
                    </div>
                  </div>
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600 text-sm">Standard shipping takes 3-5 business days. Express shipping is available for 1-2 days.</p>
            </div>
            
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="font-semibold text-gray-900 mb-2">Do you ship internationally?</h3>
              <p className="text-gray-600 text-sm">Yes, we ship to over 50 countries worldwide with carbon-neutral shipping options.</p>
            </div>
            
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="font-semibold text-gray-900 mb-2">Are your products really eco-friendly?</h3>
              <p className="text-gray-600 text-sm">All our products are carefully vetted for environmental impact and sustainability standards.</p>
            </div>
          </div>
        </div>
      </section>
